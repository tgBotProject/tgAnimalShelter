# Телеграмм-бот приюта
Телеграмм-бот приюта отвечает на популярные вопросы людей о том, что нужно знать и уметь, чтобы забрать животное из приюта. В проекте участвуют: 
<ul>
...
## Определение запроса
На данном этапе бот приветствует нового пользователя, рассказывает о себе и просит пользователя выбрать приют:
- Приют для кошек
- Приют для собак
...
# Backend
Java 17, Maven, Spring Boot, GIT, Swagger, PostgreSQL, REST
